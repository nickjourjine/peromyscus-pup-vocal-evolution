...
#make spectrograms from wav clips in the directory clips_dir using parameters in the spec_params dictionary
#then pad them to the length of the longest clip in clips_dir
#returns a list of padded spectrograms
#
...
#go throught he full pipeline from spectrogram generation to umap plotting
